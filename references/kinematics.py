...
if __name__ == "__main__":
    ...
    q = torch.tensor([[[0.0, 1.3222, 1.9735],[0.0, 1.3222, 1.9735],[0.0, 1.3222, 1.9735],[0.0, 1.3222, 1.9735],[0.0, 1.3222, 1.9735],[0.0, 1.3222, 1.9735]]], dtype=torch.float32, device=device)
    # 调用前向运动学函数计算脚的位置
